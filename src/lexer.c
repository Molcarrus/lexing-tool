...
token next_token(lexer* l) {
    ...
    switch (l->ch) {
        ...
        case ':':
            t = new_char_token(COLON, l->ch);
            break;

        case ';':
            t = new_char_token(SEMICOLON, l->ch);
            break;
        ...
        case '~':
            t = new_char_token(BIT_NOT, l->ch);
            break;
        
        case '(':
            t = new_char_token(LPAREN, l->ch);
            break;

        case ')':
            t = new_char_token(RPAREN, l->ch);
            break;

        case ',':
            t = new_char_token(COMMA, l->ch);
            break;
        ...
        case '{':
            t = new_char_token(LBRACE, l->ch);
            break;

        case '}':
            t = new_char_token(RBRACE, l->ch);
            break;

        case '[':
            t = new_char_token(LBRACK, l->ch);
            break;
        
        case ']':
            t = new_char_token(RBRACK, l->ch);
            break;

        case '\0':
            t = new_char_token(t_EOF, l->ch);
            break;
